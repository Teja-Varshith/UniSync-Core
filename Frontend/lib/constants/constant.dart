...
const totoUrl =
    'https://api.campx.in/student-api/student-attendance?fromDate=&toDate=';
const totoourl =
  ...
  return base.copyWith(
    ...
    outlinedButtonTheme: OutlinedButtonThemeData(
      style: ButtonStyle(
        ...
        foregroundColor:
            const MaterialStatePropertyAll(UniSyncColors.buttonSecondaryFg),
    ...
    elevatedButtonTheme: ElevatedButtonThemeData(
      style: ButtonStyle(
        ...
        foregroundColor:
            const MaterialStatePropertyAll(UniSyncColors.buttonPrimaryFg),
      ),
    ),
    textButtonTheme: TextButtonThemeData(
      style: ButtonStyle(
        foregroundColor:
            const MaterialStatePropertyAll(UniSyncColors.buttonGhostFg),
